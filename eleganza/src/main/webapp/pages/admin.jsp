...
<body>
  ...
  <div class="admin-container">
    <div class="container">
      ...
      <!-- Admin Tabs -->
      <div class="admin-nav">
        <button id="btnProductos" class="admin-btn">Productos</button>
        <button id="btnUsuarios" class="admin-btn">Usuarios</button>
        <button id="btnPedidos" class="admin-btn">Pedidos</button>
      </div>

      <div id="seccionProductos" class="admin-section">
        <!-- Aquí ya tienes tu tabla de productos -->
      ...
      <div id="seccionUsuarios" class="admin-section" style="display:none;">
        <!-- Aquí se mostrará la tabla de usuarios -->
        <h3>Gestión de Usuarios</h3>
        <p>Esta sección está en desarrollo.</p>
      </div>
      <div id="seccionPedidos" class="admin-section" style="display:none;">
        <!-- Aquí se mostrará la tabla de pedidos -->
    ...
    <div class="modal">
      ...
      <div class="modal-body">
        <form id="productForm">
          ...
          <div class="form-group">
            <label for="productIcon" class="form-label">Foto (emoji o URL)</label>
            <input type="text" id="productIcon" class="form-input" placeholder="👗 o https://ejemplo.com/imagen.jpg" required>
          </div>
          <div class="form-group">
